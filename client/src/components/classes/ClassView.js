...
function ClassView(props) {
  ...
  const addRefreshr = () => {
    ...
    axios
      .post(url, new_refresher, headers)
      .then(res => {
    ...
    <Grid container>
      <Grid item xs={10}>
        <div>
          ...
          <button onClick={addRefreshr} style={{ background: 'limegreen' }}>
            addRefreshr
          </button>
          <button onClick={getRefreshr} style={{ background: 'goldenrod' }}>
            getRefreshr
          </button>
          <button onClick={getRefreshrs} style={{ background: 'goldenrod' }}>
            getRefreshrs
          </button>
          <button onClick={updateRefreshr} style={{ background: 'lightpink' }}>
            updateRefreshr
          </button>
          <button onClick={deleteRefreshr} style={{ background: 'crimson' }}>
            deleteRefreshr
          </button>
          <div>
            <button
            ...
            <button
              onClick={getScheduleRefreshr}
              style={{ background: 'goldenrod' }}
            >
              getScheduleRefreshr
            </button>
            <button
              onClick={rescheduleRefreshr}
              style={{ background: 'lightpink' }}
            >
              rescheduleRefreshr
            </button>
            <button
              onClick={deleteScheduleRefreshr}
              style={{ background: 'crimson' }}
            >
              deleteScheduleRefreshr
            </button>
            <button onClick={sendTestRefreshr} style={{ background: 'teal' }}>
              sendTestRefreshr
            </button>
          </div>
        </div>
