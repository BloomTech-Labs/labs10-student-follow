...
// This gets all users and displays in the body
...
// This route checks for an existing user. If the body is an empty array, the user doesn't exist. If it conatins data, the user does exist
router.get('/email', async (req, res) => {
  try {
    const users = {
      method: 'GET',
      url:
        'https://nickoferrall.auth0.com/api/v2/users-by-email?email=nicktest@gmail.com',
      headers: {
        authorization:
          'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsImtpZCI6Ik5qUTRSRU5CT1RWQlJqSkNNa0l5T1VGRk1EUTNNa00xTlRKQ1EwWXlSVU5DTVRnME9FRkRNUSJ9..ISFYm_ZyEuROpyJ-SMiCrHW1rlQ8byQG41Ng1LscZsEE-EFN6QldoXqSJH-wMpQmjv1Q8qwztczq084C6vMQ48F73L0z50X02F9415elsFCH0NPrTYBIIN4ulZos18-nb7mOqMK6tHhSXa8oszpOWBLZHQlfEYSaQ7L3dMMth19YuEz4Wymll0TevnoYdECviOqyOCCvO4Dvu-ouigvRVF3kV_4cOoQNr5xPqWJ0swp34k9xvTy8NM14y8yCY-q8f9HIHlNBj9orfTFZdwea88zJHp0IQLbxfxMOhzAcB-Xht0MZNqoR5Qpiy1SS5_FaReGXO3yeGn6YmqMBU7XSEQ',
        'content-type': 'application/json; charset=utf-8'
